...
<nav class="fixed z-30 w-full bg-white border-2 border-b dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="/" class="flex ml-2 md:mr-24">
                    <img src="..../assets/images/logo.jpg" class="h-8 mr-3" alt="logo" />
                    <span
                        class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Royal Mad</span>
                </a>
