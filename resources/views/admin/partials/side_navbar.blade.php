                ...
                <ul class="pb-2 space-y-2">
                    ...
                    <li class="@yield('dashboard_select')">
                        <a href="{{ route('dashboard') }}"
                            ...
                            <svg class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white active:@yield('dashboard_select')"
                    ...
                    <li class="@yield('category_select')">
                        <a href="{{ url('dashboard/brand') }}"
                            class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                            <svg class="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512">
                            ...
                            <span class="ml-3" sidebar-toggle-item>brand</span>
                        </a>
                    </li>
                    <li class="@yield('coupon_select')">
                        <a href="{{ url('dashboard/coupon') }}"
                            class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                            <svg class="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                <path
                            ...
                            <span class="ml-3" sidebar-toggle-item>Coupon</span>
                        </a>
                    </li>
                    <li class="@yield('coupon_select')">
                        <a href="{{ url('dashboard/size') }}"
                            ...
                            <span class="ml-3" sidebar-toggle-item>Size</span>
                        </a>
                    </li>
                    <li class="@yield('coupon_select')">
                        <a href="{{ url('dashboard/color') }}"
                            ...
                            <span class="ml-3" sidebar-toggle-item>Color</span>
                        </a>
                    </li>
                    <li class="@yield('coupon_select')">
                    ...
                    <li class="@yield('coupon_select')">
                        <a href="{{ url('dashboard/tax') }}"
                            class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                <path
                                    d="M326.3 218.8c0 20.5-16.7 37.2-37.2 37.2h-70.3v-74.4h70.3c20.5 0 37.2 16.7 37.2 37.2zM504 256c0 137-111 248-248 248S8 393 8 256 119 8 256 8s248 111 248 248zm-128.1-37.2c0-47.9-38.9-86.8-86.8-86.8H169.2v248h49.6v-74.4h70.3c47.9 0 86.8-38.9 86.8-86.8z" />
                            </svg>
                            <span class="ml-3" sidebar-toggle-item>Tax</span>
                        </a>
                    </li>
                    <li class="@yield('coupon_select')">
