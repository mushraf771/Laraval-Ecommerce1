  ...
  <div class="container py-16 ">
    <div class="w-10/12 grid grid-col sm:grid-cols-3 gap-6 mx-auto justify-center items-center">
        <div class=" rounded-sm px-3 py-6 flex justify-center items-center gap-5 bg-white">
