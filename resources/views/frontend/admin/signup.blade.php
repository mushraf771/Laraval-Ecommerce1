@extends('welcome')
@section('data')
    <div class=" flex justify-center  p-2 min-h-screen m-2">

        <div class="shadow-lg border p-5 rounded-md mt-6 bg-white ">
            <p class="mb-0 mr-4 text-4xl font-bold text-center pb-6">Sign Up</p>
            ...
            <form action="{{ route('admin.store') }}" method="POST" autocomplete="false">
...
@csrf
                ...
                <div class="relative mb-4" data-te-input-wrapper-init>
                    <div class="space-y-2">
                        <div>
                            <label for="name" class="text-gray-600 mb-2 block">Full Name <span class="text-baseColor">
                                    *</span></label>
                        ...
                        <div>
                            <label for="email" class="text-gray-600 mb-2 block">Email Address
                                <span class="text-baseColor"> *</span></label>
                        ...
                        <div>
                            <label for="confirm" class="text-gray-600 mb-2 block">Confirm password
                                <span class="text-baseColor"> *</span></label>
                            <div class="relative  w-full flex items-center">
                                <input type="password" name="confirm" id="password2"
                                    class="block w-full border rounded border-gray-300 px-4 py-3 text-gray-600 text-sm  focus:ring-0 focus:border-baseColor placeholder-gray-400"
                                    placeholder="*******">
                ...
                <div class=" pb-1 pt-1 text-center">
                    ...
                    <!-- {{-- <div class="pt-4"><a class="" href="#!">Forgot password?</a></div> --}} -->
                </div>
