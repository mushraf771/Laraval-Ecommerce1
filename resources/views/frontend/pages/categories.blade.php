                        ...
                        @foreach ($data as $item)
                            @if ($item->children)
                                    ...
                                    <div class="bg-white shadow rounded overflow-hidden group">
                                        <div class="relative">
                                            <a href="{{ $item->slug }}/{{ $child->slug }}" class="">
                                                <img src="{{ Storage::url($child->category_image) }}" alt="product 1"
                                                    class="w-full h-auto">
                                            </a>
                                            <div
                                ...
                                justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                                        ...
                                        <a href="{{ $child->slug }}"
                                            class="block w-full py-1 text-center text-white bg-baseColor border bg-baseColor rounded-b hover:bg-transparent hover:text-baseColor transition">
                                        sub categories</a>
                                        <a href="/product/{{ $child->slug }}"
                                            class="block w-full py-1 text-center text-white bg-baseColor border bg-baseColor rounded-b hover:bg-transparent hover:text-baseColor transition">
                                           child categories</a>
