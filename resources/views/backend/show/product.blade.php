...
@section('content')
        ...
        <div class="flex items-center justify-between pb-4">
            ...
            <div class="">
                <a href="{{ route('dashboard.product.create') }}"
                    class="p-1 bg-primary text-white">{{ __('Add Product') }}</a>
            </div>
        </div>
            ...
            <tbody>
                @foreach ($products as $product)
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <img class="w-6 h-6" src="{{ Storage::url($product->image) }}" alt="image not found" >
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex gap-x-4">
                                @if ($product->status == 1)
                                    <a href="{{ url('dashboard/product/status/0') }}/{{ $product->id }}"
                                        class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Hide</a>
                                @else
                                    <a href="{{ url('dashboard/product/status/1') }}/{{ $product->id }}"
    ...
    <div class="px-6 py-4 w-full">
        <h2 class="text-3xl">No product Added Yet </h2>
    </div>
