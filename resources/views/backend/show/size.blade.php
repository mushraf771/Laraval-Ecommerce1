...
@section('content')
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-6">
        ...
        <div class="flex items-center justify-between pb-4">
            ...
            <div class="">
                <a href="{{ route('dashboard.size.create') }}" class="p-1 bg-primary text-white">
                    {{ __('Add Size') }}
                </a>
            </div>
        </div>
            ...
            <tbody>
                @foreach ($sizes as $size)
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4">
                            {{-- <img src="{{ Storage::url($size->image) }}" alt="" class=" w-14 h-16"> --}}
                        </td>
                        <td class="px-6 py-4">
                            {{-- {{ $size->description }} --}}
                        </td>
...
<a href="{{ url('dashboard/size/delete')}}/{{$size->id  }}" class=""><button type="button"
                                    class="font-medium text-red-600 dark:text-red-500 hover:underline">Delete</button>
</a>                        </div>
                    </td>
                    </tr>
