...
@section('content')
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-6">
        ...
        <div class="flex items-center justify-between pb-4">
            ...
            <div class="">
                <a href="{{ route('dashboard.color.create') }}" class="p-1 bg-primary text-white">
                    {{ __('Add Color') }}
                </a>
            </div>
        </div>
            ...
            <tbody>
                @foreach ($colors as $color)
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4">
                            {{-- <img src="{{ Storage::url($color->image) }}" alt="" class=" w-14 h-16"> --}}
                        </td>
                        <td class="px-6 py-4">
                            {{-- {{ $color->description }} --}}
                        </td>
                        <td class="px-6 py-4">
                            <div class="flex gap-x-4">
                                ...
                                @if ($color->status == 1)
                                    <a href="{{ url('dashboard/color/status/0') }}/{{ $color->id }}"
                                        class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Hide</a>
                                @else
                                    <a href="{{ url('dashboard/color/status/1') }}/{{ $color->id }}"
                                        class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Show</a>
                                @endif
                                <a href="{{ url('dashboard/color/edit') }}/{{ $color->id }}"
                                    class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                                {{-- <form method="POST" onsubmit="return confirm(' Are You Sure...?');"
                                action={{ route('dashboard.color.destroy', $color->id) }}>
                                @csrf
                                @method('DELETE')
                                <button type="submit"
                                ...
                                <a href="{{ url('dashboard/color/delete') }}/{{ $color->id }}" class=""><button
                                        type="button"
                                        class="font-medium text-red-600 dark:text-red-500 hover:underline">Delete</button>
                                </a>
                            </div>
    ...
    <div class="px-6 py-4 w-full">
        <h2 class="text-3xl">No color Added Yet </h2>
    </div>
