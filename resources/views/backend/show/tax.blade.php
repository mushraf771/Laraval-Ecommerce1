...
@section('content')
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-6">
        ...
        <div class="flex items-center justify-between pb-4">
            ...
            <div class="">
                <a href="{{ route('dashboard.tax.create') }}" class="p-1 bg-primary text-white">
                    {{ __('Add Tax') }}
                </a>
            </div>
        </div>
            ...
            <tbody>
                @foreach ($taxes as $tax)
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4">
                            {{-- <img src="{{ Storage::url($tax->image) }}" alt="" class=" w-14 h-16"> --}}
                        </td>
                        <td class="px-6 py-4">
                            {{-- {{ $tax->description }} --}}
                        </td>
...
<a href="{{ url('dashboard/tax/delete')}}/{{$tax->id  }}" class=""><button type="button"
                                    class="font-medium text-red-600 dark:text-red-500 hover:underline">Delete</button>
</a>                        </div>
                    </td>
                    </tr>
    ...
    <div class="pt-6">
        {{-- {{ $tax->onEachSide(5)->links() }} --}}
    </div>
    {{-- @else --}}
    <div class="px-6 py-4 w-full">
        <h2 class="text-3xl">No size Added Yet </h2>
    </div>
