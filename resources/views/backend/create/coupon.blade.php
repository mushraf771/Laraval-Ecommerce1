    ...
    <div class="p-4">
        <div class="m-2 grid grid-cols-1 p-4 sm:grid-cols-9 gap-4">
            <div class="col-span-9 shadow rounded-md ">
                <div class="px-4 py-6">
                    <form method="POST" autocomplete="false" action="{{ route('dashboard.coupon.store') }}"  enctype="multipart/form-data">
                        @csrf
                        <div class="grid gap-6 mb-6 md:grid-cols-5">
                            ...
                            <div>
                                ...
                                <input min_order_amt="text" name="min_order_amt" id="min_order_amt" min_order_amt="{{ old('min_order_amt') }}"
